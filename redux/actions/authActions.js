...
const authActions = {
    postUser: (newUser) => {
        ...
        return async (dispatch, getState) => {
            try {
                const user = await axios.post("https://mytinerary-sagario.herokuapp.com/api/auth/signUp",
                    { ...newUser })
    ...
    signIn: (email, password, google) => {
        return async (dispatch, getState) => {
            try {
                const user = await axios.post("https://mytinerary-sagario.herokuapp.com/api/auth/signIn", 
