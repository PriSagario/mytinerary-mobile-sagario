...
const itinerariesActions = {
    getItineraries: (city_id) => {
        return async (dispatch, getState) => {
            let response = await axios.get("https://mytinerary-sagario.herokuapp.com/api/itinerary/" + city_id)
    ...
    likes: (userId, itineraryId, city_id) => {
        return async (dispatch, getState) => {
            if(userId && itineraryId){
                await axios.put("https://mytinerary-sagario.herokuapp.com/api/like/", { itineraryId, userId} )
                let response = await axios.get("https://mytinerary-sagario.herokuapp.com/api/itinerary/" + city_id)
    ...
    getComments: (itineraryId) => {
        return async (dispatch, getState) => {
            let response = await axios.get("https://mytinerary-sagario.herokuapp.com/api/comments/" + itineraryId)
    ...
    postComments: (itineraryId, user, message) => {
        ...
        return async(dispatch, getState)=>{
            if(user && itineraryId){
                await axios.post("https://mytinerary-sagario.herokuapp.com/api/comments/" + itineraryId, {user, message})
    ...
    editComments: (commentId, message) => {
        return async(dispatch, getState)=>{
            ...
            await axios.put("https://mytinerary-sagario.herokuapp.com/api/comments" , {commentId, message}, {
                headers: {
